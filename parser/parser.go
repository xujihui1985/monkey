...
func New(l *lexer.Lexer) *Parser {
	...
	p.registerPrefix(token.MIUS, p.parsePrefixExpression)
	...
	p.registerInfix(token.MIUS, p.parseInfixExpression)
	p.registerInfix(token.LG, p.parseInfixExpression)
